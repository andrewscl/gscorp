package com.gscorp.dv1.operations.forecast.application;
...
import com.gscorp.dv1.operations.forecast.infrastructure.Forecast;
import com.gscorp.dv1.operations.forecast.infrastructure.ForecastRepository;
import com.gscorp.dv1.operations.forecast.infrastructure.ForecastSeriesProjection;
import com.gscorp.dv1.operations.forecast.web.dto.ForecastCreateDto;
import com.gscorp.dv1.operations.forecast.web.dto.ForecastFormPayload;
import com.gscorp.dv1.operations.forecast.web.dto.ForecastFormPrefill;
import com.gscorp.dv1.operations.forecast.web.dto.ForecastPointDto;
import com.gscorp.dv1.operations.forecast.web.dto.ForecastRecordDto;
...
public List<ForecastPointDto> getForecastSeriesForUserByDates(
    ...
    for (ForecastSeriesProjection r : rows) {
        ...
        while (!d.isAfter(overlapEnd)) {
            accum.merge(d, perDay, (oldVal, newVal) -> oldVal.add(newVal));
            d = d.plusDays(1);
        }
    }
