...
import com.gscorp.dv1.operations.shiftrequests.web.dto.statistics.ProjectSiteShiftRequestsSchedulesDto;
...
public class ShiftRequestStatServiceImpl implements ShiftRequestStatService{
    ...
    public List<ProjectSiteShiftRequestsSummaryDto>
        ...
        DayOfWeek todayEnum = DayOfWeek.fromJavaTime(today.getDayOfWeek());
        ...
        for (ProjectSiteShiftRequestsSchedulesDto sc : schedules) {
            ...
            Set<DayOfWeek> allowedDays = 
                    ShiftRequestForecastHelper.buildDaySet(
                        sc.dayFrom(),
                        sc.dayTo());
        ...
        return metadataMap.entrySet().stream()
                ...
                .sorted(Comparator.comparing(
                                    (ProjectSiteShiftRequestsSummaryDto dto) -> dto.projectName(), 
                                    Comparator.nullsLast(Comparator.naturalOrder())
                ).thenComparing(
                                    (ProjectSiteShiftRequestsSummaryDto dto) -> dto.siteName(), 
                                    Comparator.nullsLast(Comparator.naturalOrder())
                ))
                .toList();
    }
