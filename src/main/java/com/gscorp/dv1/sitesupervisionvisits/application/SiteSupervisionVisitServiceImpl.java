...
public class SiteSupervisionVisitServiceImpl implements SiteSupervisionVisitService{
    ...
    public SiteSupervisionVisitDto saveSiteSupervisionVisit(
        ...
        //Buscar supervisor y sitio
        var employee = employeeService.findById(dto.supervisor().getId())
                            .orElseThrow(() -> 
                                new IllegalArgumentException("Supervisor no encontrado: " + dto.supervisor()));
